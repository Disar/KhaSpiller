...
class FlashGraphics
{
	 ...
	 */
	private static var _shapeRenderer:Graphics;
	/**
	 * The graphics instance.
	 */
	private static var _graphics:FlashGraphics;
	/**
	 ...
	 */
	public static function initGraphics():FlashGraphics
	{
		// Initialize the graphics
		if(_graphics == null) {
			_graphics = new FlashGraphics();
