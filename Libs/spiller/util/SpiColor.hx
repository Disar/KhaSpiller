 ...
 */
abstract SpiColor(Int) from Int from UInt to Int to UInt
{
	public static inline var TRANSPARENT:SpiColor = 0x00000000;
	public static inline var WHITE:SpiColor =       0xFFFFFFFF;
	public static inline var GRAY:SpiColor =        0xFF808080;
	public static inline var BLACK:SpiColor =       0xFF000000;
	
	public static inline var GREEN:SpiColor =       0xFF008000;
	public static inline var LIME:SpiColor =        0xFF00FF00;
	public static inline var YELLOW:SpiColor =      0xFFFFFF00;
	public static inline var ORANGE:SpiColor =      0xFFFFA500;
	public static inline var RED:SpiColor =         0xFFFF0000;
	public static inline var PURPLE:SpiColor =      0xFF800080;
	public static inline var BLUE:SpiColor =        0xFF0000FF;
	public static inline var BROWN:SpiColor =       0xFF8B4513;
	public static inline var PINK:SpiColor =        0xFFFFC0CB;
	public static inline var MAGENTA:SpiColor =     0xFFFF00FF;
	public static inline var CYAN:SpiColor =        0xFF00FFFF;
	
	/**
	 * A Map<String, Int> which values are the static colors of SpiColor.
	 * You can add more colors for SpiColor.fromString(String) if you need.
	 */
	public static var colorLookup(default, null):Map<String,Int>
		= SpiMacroUtil.buildMap("spiller.util.SpiColor");
	 ...
	 * @return	The color as a SpiColor
	 */
	public static inline function fromInt(Value:Int):SpiColor
	{
		return new SpiColor(Value);
	}
	 ...
	 * @return The color as a SpiColor
	 */
	public static inline function fromRGB(Red:Int, Green:Int, Blue:Int, Alpha:Int = 255):SpiColor
	{
		var color = new SpiColor();
	 ...
	 * @return The color as a SpiColor
	 */
	public static inline function fromRGBFloat(Red:Float, Green:Float, Blue:Float, Alpha:Float = 1):SpiColor
	{
		var color = new SpiColor();
	 ...
	 * @return The color as a SpiColor
	 */
	public static inline function fromCMYK(Cyan:Float, Magenta:Float, Yellow:Float, Black:Float, Alpha:Float = 1):SpiColor
	{
		var color = new SpiColor();
	 ...
	 * @return	The color as a SpiColor
	 */
	public static function fromHSB(Hue:Float, Saturation:Float, Brightness:Float, Alpha:Float = 1):SpiColor
	{
		var color = new SpiColor();
	 ...
	 * @return	The color as a SpiColor
	 */
	public static inline function fromHSL(Hue:Float, Saturation:Float, Lightness:Float, Alpha:Float = 1):SpiColor
	{
		var color = new SpiColor();
	...
	/**
	 * Parses a String and returns a SpiColor or null if the String couldn't be parsed.
	 ...
	 * @return	A SpiColor or null if the String couldn't be parsed
	 */
	public static function fromString(str:String):Null<SpiColor>
	{
		var result:Null<SpiColor> = null;
		str = StringTools.trim(str);
		
		if (COLOR_REGEX.match(str)) 
		{
			var hexColor:String = "0x"+COLOR_REGEX.matched(2);
			result = new SpiColor(Std.parseInt(hexColor));
		...
		else
		{
			...
			for (key in colorLookup.keys())
			{
				...
				{
					result = new SpiColor(colorLookup.get(key));
					break;
				}
			}
		}
	 ...
	 * @return	HSB color wheel as Array of SpiColors
	 */
	public static function getHSBColorWheel(Alpha:Int = 255):Array<SpiColor>
	{
		var colors:Array<SpiColor> = new Array<SpiColor>();
	 ...
	 */
	public static inline function interpolate(Color1:SpiColor, Color2:SpiColor, Factor:Float = 0.5):SpiColor
	{
	 ...
	 */
	public static function gradient(Color1:SpiColor, Color2:SpiColor, Steps:Int, ?Ease:Float->Float):Array<SpiColor>
	{
		var output = new Array<SpiColor>();
	...
	/**
	 * Multiply the RGB channels of two SpiColors
	 */
	@:op(A * B)
	public static inline function multiply(lhs:SpiColor, rhs:SpiColor):SpiColor
	{
		return SpiColor.fromRGBFloat(lhs.redFloat * rhs.redFloat, lhs.greenFloat * rhs.greenFloat, lhs.blueFloat * rhs.blueFloat);
	}
	
	/**
	 * Add the RGB channels of two SpiColors
	 */
	@:op(A + B)
	public static inline function add(lhs:SpiColor, rhs:SpiColor):SpiColor
	{
		return SpiColor.fromRGB(lhs.red + rhs.red, lhs.green + rhs.green, lhs.blue + rhs.blue);
	}
	
	/**
	 * Subtract the RGB channels of one SpiColor from another
	 */
	@:op(A - B)
	public static inline function subtract(lhs:SpiColor, rhs:SpiColor):SpiColor
	{
		return SpiColor.fromRGB(lhs.red - rhs.red, lhs.green - rhs.green, lhs.blue - rhs.blue);
	}
	 ...
	 */
	public inline function getComplementHarmony():SpiColor
	{		
		return fromHSB(SpiMath.wrapValue(Std.int(hue), 180, 350), brightness, saturation, alphaFloat);
	}
	...
	{
		var warmer:Int = fromHSB(SpiMath.wrapValue(Std.int(hue), - Threshold, 350), saturation, brightness, alphaFloat);
		var colder:Int = fromHSB(SpiMath.wrapValue(Std.int(hue), Threshold, 350), saturation, brightness, alphaFloat);
	...
	{
		var oppositeHue:Int = SpiMath.wrapValue(Std.int(hue), 180, 350);
		var warmer:SpiColor = fromHSB(SpiMath.wrapValue(oppositeHue, - Threshold, 350), saturation, brightness, alphaFloat);
		var colder:SpiColor = fromHSB(SpiMath.wrapValue(oppositeHue, Threshold, 350), saturation, brightness, alphaFloat);
	...
	{
		var triadic1:SpiColor = fromHSB(SpiMath.wrapValue(Std.int(hue), 120, 359), saturation, brightness, alphaFloat);
		var triadic2:SpiColor = fromHSB(SpiMath.wrapValue(Std.int(triadic1.hue), 120, 359), saturation, brightness, alphaFloat);
	...
	public function getColorInfo():String
	{
		...
		// HSB/HSL info
		result += "Hue: " + SpiMath.roundDecimal(hue, 2) + " Saturation: " + SpiMath.roundDecimal(saturation, 2) + 
			" Brightness: " + SpiMath.roundDecimal(brightness, 2) + " Lightness: " + SpiMath.roundDecimal(lightness, 2);
	 ...
	 */
	public function getDarkened(Factor:Float = 0.2):SpiColor
	{
		Factor = SpiMath.bound(Factor, 0, 1);
		var output:SpiColor = this;
	 ...
	 */
	public inline function getLightened(Factor:Float = 0.2):SpiColor
	{
		Factor = SpiMath.bound(Factor, 0, 1);
		var output:SpiColor = this;
	 ...
	 */
	public inline function getInverted():SpiColor
	{
		var oldAlpha = alpha;
		var output:SpiColor = SpiColor.WHITE - this;
	 ...
	 * @return This color
	 */
	public inline function setRGB(Red:Int, Green:Int, Blue:Int, Alpha:Int = 255):SpiColor
	{
		red = Red;
		green = Green;
		blue = Blue;
	 ...
	 * @return This color
	 */
	public inline function setRGBFloat(Red:Float, Green:Float, Blue:Float, Alpha:Float = 1):SpiColor
	{
		redFloat = Red;
		greenFloat = Green;
		blueFloat = Blue;
	 ...
	 * @return This color
	 */
	public inline function setCMYK(Cyan:Float, Magenta:Float, Yellow:Float, Black:Float, Alpha:Float = 1):SpiColor
	{
	 ...
	 * @return	This color
	 */
	public inline function setHSB(Hue:Float, Saturation:Float, Brightness:Float, Alpha:Float):SpiColor
	{
	 ...
	 * @return	This color
	 */
	public inline function setHSL(Hue:Float, Saturation:Float, Lightness:Float, Alpha:Float):SpiColor
	{
	 ...
	 */
	private inline function setHSChromaMatch(Hue:Float, Saturation:Float, Chroma:Float, Match:Float, Alpha:Float):SpiColor
	{
		Hue %= 360;
		var hueD = Hue / 60;
	...
	@:commutative
	@:op(A == B)
	private static inline function equal(lhs:Null<SpiColor>, rhs:Null<Int>):Bool
	{
		return lhs == (rhs:Null<SpiColor>);
	}
	
	@:commutative
	@:op(A != B)
	private static inline function notEqual(lhs:Null<SpiColor>, rhs:Null<Int>):Bool
	{
		return lhs != (rhs:Null<SpiColor>);
	}
	#end
